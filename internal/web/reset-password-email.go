...
func (m *Module) resetPasswordEmailGETHandler(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "email_reset_html.tmpl", gin.H{
		"instance": instance,
		"email":    user.Email,
		"username": user.Email,
		"token":    user.ResetPasswordToken,
		"send_at":  user.ResetPasswordSentAt,
	})
}
